...
# #     list_links = []
# #     for Links in links:
# #         if Links.submitter_id == 62443:
# #             list_links.append(Links)
# #     list_links.sort(key = lambda Link: Link.submitted_time)
# #     return list_links
...
# #dict example = dict((m[3].lower(),m) for m in months)

# def build_link_index():
#     index = dict((Link.id,Link) for Link in links)
#     return index
